...
{
    /// <inheritdoc />
    public partial class MergeAmr_Hamdy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSubs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceCode = table.Column<string>(type: "VARCHAR(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicantTransactions_AppSubs_ApplicantSubscraptionId",
                        column: x => x.ApplicantSubscraptionId,
                        principalTable: "AppSubs",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicantAdvertisements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicantAdvertisements_Applicants_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ApplicantAdvertisements_JobAdvertisments_JobAdvertismentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_ApplicantAdvertisements_ApplicantAdvertismentId",
                        column: x => x.ApplicantAdvertismentId,
                        principalTable: "ApplicantAdvertisements",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicantAdvertisements_ApplicantId",
                table: "ApplicantAdvertisements",
                column: "ApplicantId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantAdvertisements_JobAdvertismentId",
                table: "ApplicantAdvertisements",
