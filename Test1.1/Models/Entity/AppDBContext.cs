...
namespace Test1._1.Models.Entity
{
    public class AppDBContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ApplicantTransactionConfigration());
            modelBuilder.ApplyConfiguration(new AppSubConfigration());
            modelBuilder.ApplyConfiguration(new CompanyTransactionConfigration());
        }
    }
}